...
namespace LAB03
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            // 1 Implicit Conversion : Current HP (int) -> double
            ...
            Console.WriteLine();
            // 2 Calculate Percent --> double
            Console.WriteLine("----- Exact HP Percent (no integer truncation) -----");
            double hpPercentExact = currentHpDouble * 100 / maxHp;
            Console.WriteLine($"HP Percent (exact): {hpPercentExact}%");
            Console.WriteLine();
            // 3 Explicit Conversion Cast attackPower (float) -> int
            ...
            Console.WriteLine();
            // 4 Cast vs. Convert critMultiplier (double) -> int
